; ------------------------------------------------------------------------------------------------------------- ;
; Hansmanns Castles of Dr Creep - Room and Item Data Maps
; ------------------------------------------------------------------------------------------------------------- ;
; Item Data Map
; ------------------------------------------------------------------------------------------------------------- ;
CC_ItemData                   = $00                    ; 
...
CC_Lock_Status                 = $01                   ;       not used - CC_WA_Item_Door_Status taken instead
CC_Lock_Status_Open              = $00                 ; Flag: door already open
; ------------------------------------------------------------------------------------------------------------- ;
