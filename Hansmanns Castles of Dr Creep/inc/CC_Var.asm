; --------------------------------------------------------------------------------------------------------------------- ;
; Hansmanns Castles of Dr Creep - In game variables
; --------------------------------------------------------------------------------------------------------------------- ;
; memory layout
; --------------------------------------------------------------------------------------------------------------------- ;
...
;CC_MemUnused               = $b900 ; - $b9ff: not used                                                                 .hbu013.removed
CC_MemStatusCtrl            = $b900 ; - $b9ff: Player Status Ctrl to reset the room after death                         .hbu013.
...
CC_MemStatusData            = $d000 ; - $b7ff: Player room data to reset a room after death                         .hbu013.
...
; --------------------------------------------------------------------------------------------------------------------- ;
CC_GameDataVar_Keys_Got       = CC_GameDataVar + $13        ;       number of keys picked up - count start: 01
CC_GameDataVar_Keys_Got_P1      = CC_GameDataVar + $13      ;       
CC_GameDataVar_Keys_Got_P2      = CC_GameDataVar + $14      ;       
CC_GameDataVar_Keys_Got_None      = $00                     ; 
; --------------------------------------------------------------------------------------------------------------------- ;
...
; --------------------------------------------------------------------------------------------------------------------- ;
; Work Area Player Status - to reset the room after death   ; $b900-$b9ff                                               .hbu013.
; --------------------------------------------------------------------------------------------------------------------- ;
CC_WA_Status                = CC_MemStatusCtrl              ;                                                           .hbu013.
CC_WA_Status_Target_Room      = CC_WA_Status + $00          ; players target room number                                .hbu013.
CC_WA_Status_Target_Room_P1     = CC_WA_Status + $00        ;                                                           .hbu013.
CC_WA_Status_Target_Room_P2     = CC_WA_Status + $01        ;                                                           .hbu013.
CC_WA_Status_Target_Door      = CC_WA_Status + $02          ; players target room door number                           .hbu013.
CC_WA_Status_Target_Door_P1     = CC_WA_Status + $02        ;                                                           .hbu013.
CC_WA_Status_Target_Door_P2     = CC_WA_Status + $03        ;                                                           .hbu013.
CC_WA_Status_Keys_Got         = CC_WA_Status + $04          ; players number collected keys                             .hbu013.
CC_WA_Status_Keys_Got_P1        = CC_WA_Status + $04        ;                                                           .hbu013.
CC_WA_Status_Keys_Got_P2        = CC_WA_Status + $05        ;                                                           .hbu013.
; --------------------------------------------------------------------------------------------------------------------- ;
; save area for current room data - allow a reset of the current room after death
; --------------------------------------------------------------------------------------------------------------------- ;
CC_WA_Status_Room            = CC_WA_Status + $06           ;                                                           .hbu013.
CC_WA_Status_Room_Start        = CC_WA_Status + $06         ; current room start address                                .hbu013.
CC_WA_Status_Room_Start_Lo       = CC_WA_Status + $06       ;                                                           .hbu013.
CC_WA_Status_Room_Start_Hi       = CC_WA_Status + $07       ;                                                           .hbu013.
CC_WA_Status_Room_End          = CC_WA_Status + $08         ; current room end address                                  .hbu013.
CC_WA_Status_Room_End_Lo         = CC_WA_Status + $08       ;                                                           .hbu013.
CC_WA_Status_Room_End_Hi         = CC_WA_Status + $09       ;                                                           .hbu013.
; --------------------------------------------------------------------------------------------------------------------- ;
CC_WA_Status_Room_Data       = CC_MemStatusData             ; current room data                                         .hbu013.
; --------------------------------------------------------------------------------------------------------------------- ;
...
; --------------------------------------------------------- ; ------------------------------------------------- ;
CC_WA_Mummy_Count_Move        = CC_WA_Sprite + $0e          ;       counter for mummy sprite num table access   .hbu009.
; --------------------------------------------------------- ; ------------------------------------------------- ;
CC_WA_Sprite_FireButton_Gun   = CC_WA_Sprite + $0f          ;       player fire button status for ray gun       .hbu014.
; --------------------------------------------------------- ; ------------------------------------------------- ;
CC_WA_Sprite_MummyColl_Le     = CC_WA_Sprite + $10          ;       avoid mummies piling up                     .hbu008.
CC_WA_Sprite_MummyColl_Yes      = $ff                       ;                                                   .hbu008.
CC_WA_Sprite_MummyColl_No       = $00                       ;                                                   .hbu008.
CC_WA_Sprite_MummyColl_Ri     = CC_WA_Sprite + $11          ;                                                   .hbu008.
CC_WA_Sprite_MummyColl_Walk   = CC_WA_Sprite + $12          ;       speed adjustment store                      .hbu008.
; --------------------------------------------------------- ; ------------------------------------------------- ;
...
CC_WA_Sprite_Len            = $20                           ; 
; --------------------------------------------------------------------------------------------------------------------- ;
; Room Item Definition Work Area - max $20 blocks of $08 bytes ; $bf00-$bfff
; --------------------------------------------------------------------------------------------------------------------- ;
...
; player colors
; --------------------------------------------------------------------------------------------------------------------- ;
CC_Player_Color_P1          = YELLOW ;                                                                        .hbu016.
CC_Player_Color_P2          = ORANGE ;                                                                        .hbu016.
CC_Player_Color_Shirt       = RED    ; LT_RED                                                                 .hbu016.
CC_Player_Color_Trouser     = GREEN  ; LT_GREEN                                                               .hbu016.
; --------------------------------------------------------------------------------------------------------------------- ;
RoomItemDataMapping         .include "CC_Items.asm"      ; Room Item Data Maps
; --------------------------------------------------------------------------------------------------------------------- ;
