; --------------------------------------------------------------------------------------------------------------------- ;
; Hansmanns Castles of Dr Creep - Zero Page Equates
; --------------------------------------------------------------------------------------------------------------------- ;
...
CCZ_CastleTimePtr           = $30                           ; ptr : castle escape time in castls data variales area
...
CCZ_KeyCollectBufPtr        = $30                           ; ptr : list of picked keys memory in castles data variables area
...
; --------------------------------------------------------------------------------------------------------------------- ;
CCZ_RoomSaveDataSrce        = $50                           ; ptr: actual room data start                               .hbu013.
CCZ_RoomSaveDataSrce_Lo       = $50                         ;                                                           .hbu013.
CCZ_RoomSaveDataSrce_Hi       = $51                         ;                                                           .hbu013.
                            
CCZ_RoomSaveDataTarg        = $52                           ; ptr: actual room data start                               .hbu013.
CCZ_RoomSaveDataTarg_Lo       = $52                         ;                                                           .hbu013.
CCZ_RoomSaveDataTarg_Hi       = $53                         ;                                                           .hbu013.
; --------------------------------------------------------------------------------------------------------------------- ;
CCZ_RoomAdjustDataPtrs      = $54                           ; ptr: actual room data start                               .hbu021.not implemented
CCZ_RoomAdjustDataPtrs_Lo     = $54                         ;                                                           .hbu021.not implemented
CCZ_RoomAdjustDataPtrs_Hi     = $55                         ;                                                           .hbu021.not implemented
; --------------------------------------------------------------------------------------------------------------------- ;
